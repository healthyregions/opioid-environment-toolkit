...
First we load in the shapefile containing the census tract data information and geographic boundaries. Remember, this type of data (a shapefile) is actually comprised of multiple files. All need to be present in order to read correctly.
...
```{r}
#st_write(Chi_tracts.3435, "ChiTracts-3435.gpkg")
```
